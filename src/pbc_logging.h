...
/*
  $Id: pbc_logging.h,v 1.15 2003-07-02 23:27:05 willey Exp $
 */
...
typedef void pbc_log_func(apr_pool_t *p, int priority, const char *msg);
 ...
 */
void pbc_vlog_activity(apr_pool_t *p, int logging_level, const char *format, va_list arg);
