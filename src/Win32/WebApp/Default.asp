...
<p><b>LOGOUT links:</b></p>

<ul>
<li><a href="app-only-logout/">invoke app-only-logout</a>
<li><a href="app-and-redirect-logout/">invoke app-and-redirect-logout</a>
<li><a href="app-and-clearLogin-logout/">invoke app-and-clearLogin-logout</a>
</ul>
