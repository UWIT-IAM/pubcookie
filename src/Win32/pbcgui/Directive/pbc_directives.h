#define NUM_DIRECTIVES 11
	...
	directive[6].description  = L"\t*Deprecated*\n\nURL of Pubcookie login server. Use Login_URI instead.  Login_URI takes precedence if both are set.";
	...
	directive[9].description  = L"Set Pubcookie header values even if not using Pubcookie authentication\n0:Off, Non-zero:On";
