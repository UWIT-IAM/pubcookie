...
/*
    $Id: pbc_myconfig.h,v 1.11 2003-07-02 23:27:05 willey Exp $
 */
 ...
 */
extern int libpbc_myconfig_init(apr_pool_t *p, const char *alt_config, const char *ident);
 ...
 * free().  */
extern const char *libpbc_myconfig_getstring(apr_pool_t *p, const char *key, const char *def);
 ...
 */
extern int libpbc_myconfig_getint(apr_pool_t *p, const char *key, int def);
 ...
 * it isn't found 
 */
extern int libpbc_myconfig_getswitch(apr_pool_t *p, const char *key, int def);
...
extern char **libpbc_myconfig_getlist(apr_pool_t *p, const char *key);
